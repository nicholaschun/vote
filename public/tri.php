...
<div id="container">
    <div class="title">General Secretary</div>
    ...
    <div class="container">
        <div class="mini-container">
            ...
            <div class="content">
                <form action="catur.php" method="post" name="prezform">
                    ...
                    foreach($return as $row2){
                        ...
                        echo "<td><button class='vote' name='scandidate' value='$row2[candidate_id]' id='vote-button'>Vote</button></td>";
                    }
                    echo "</tr>";
                    echo "</table> ";

                    echo " <div class='skip'>
        <button class='skip' name='scandidate' value='100'>Skip</button>
    </div>";
                    echo "<input type='hidden' name='pagination' value='3'>";
