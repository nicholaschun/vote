...
echo"</tr>";
        ...
        foreach($return as $row2){
            ...
            echo "<td><button class='vote' name='vcandidate' value='$row2[candidate_id]' id='vote-button'>Vote</button></td>";
        }
        echo "</tr>";
        echo "</table> ";

        echo " <div class='skip'>
        <button class='skip' name='vcandidate' value='100'>Skip</button>
    </div>";
