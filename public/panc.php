...
<div id="container">
    <div class="title">Organising  Secretary</div>
    ...
    <div class="container">
        <div class="mini-container">
            ...
            <div class="content">
                <form action="sas.php" method="post" name="prezform">
                    ...
                    foreach($return as $row2){
                        ...
                        echo "<td><button class='vote' name='ocandidate' value='$row2[candidate_id]' id='vote-button'>Vote</button></td>";
                    }
                    echo "</tr>";
                    echo "</table> ";

                    echo " <div class='skip'>
        <button class='skip' name='ocandidate' value='100'>Skip</button>
    </div>";
                    echo "<input type='hidden' name='pagination' value='5'>";
