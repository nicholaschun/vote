...
<div id="container">
    ...
    <tr><td><h1 style="margin-top:350px; margin-left:400px; color: #6592c8;width: 500px;">Organizing Secretary </h1></td></tr>
    ...
    <button onclick="location.href='sum.php'">Next</button>
</div>
